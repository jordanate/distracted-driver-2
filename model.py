...
stat_1 = '<p style="color:Black; font-size:18px;"> &nbsp • &nbsp 9 people per day were killed due to distracted driving</p>'
stat_2 = '<p style="color:Black; font-size:18px;"> &nbsp • &nbsp 424,000 people were injured from a car crash involving a distracted driver</p>'
stat_3 = '<p style="color:Black; font-size:18px;"> &nbsp • &nbsp Of the people killed in distracted driving accidents, 1 in 5 of these individuals were not in vehicles (i.e., walking, biking, etc.)</p>'
