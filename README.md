...
Through the use of Convolutional Neural Networks (CNNs) and transfer learning, I produced 10 different models to eventually achieve the best accuracy score: 90.53%.
